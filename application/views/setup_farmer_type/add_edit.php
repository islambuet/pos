...
<form id="save_form" action="<?php echo site_url($CI->controller_url.'/index/save');?>" method="post">
    ...
    <div class="row widget">
        ...
        <div class="row show-grid">
            <div class="col-xs-4">
                <label class="control-label pull-right"><?php echo $this->lang->line('LABEL_DISCOUNT_COUPON');?></label>
            </div>
            <div class="col-sm-4 col-xs-8">
                <input type="text" name="item[discount_coupon]" id="discount_coupon" class="form-control float_type_positive" value="<?php echo $item['discount_coupon'];?>"/>
            </div>
        </div>
        <div class="row show-grid">
            <div class="col-xs-4">
                <label class="control-label pull-right"><?php echo $this->lang->line('LABEL_DISCOUNT_NON_COUPON');?></label>
            </div>
            <div class="col-sm-4 col-xs-8">
