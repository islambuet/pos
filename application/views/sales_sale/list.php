        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columnsreorder: true,
                columns: [
                    { text: '<?php echo $CI->lang->line('LABEL_OUTLET_NAME'); ?>', dataField: 'outlet_name',width:'200',cellsrenderer: cellsrenderer,filtertype: 'list'},
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_AMOUNT_PAYABLE'); ?>', dataField: 'amount_payable',cellsAlign:'right',cellsrenderer: cellsrenderer}
                ]
            });
    });
</script>